...
:vs2019
set "VS_VER=16"
if "%PLATFORM%" == "x64" (set "TARGET=Visual Studio 16 2019") else (set "TARGET=Visual Studio 16 2019")
set "ARCH=-A x64"
:rest
...
cmake -E chdir ../Urho3D_Windows cmake -G "%TARGET%" %ARCH% ../Urho3D_Windows %RENDERER_FLAGS% -DURHO3D_WEBP=0 -DURHO3D_PCH=0 -DURHO3D_LUA=0 -DURHO3D_ANGELSCRIPT=0 ../../%URHO3D_SRC_DIR%/
